...
public class SVGPawnPiece extends SVGChessPiece {
    ...
    public Element getChessPieceElement(String id, Location location, Colour pieceColour) {
        ...
        appendNewPath(g, "M 18.950592,3139.9627 C 27.356133,3140.0207 35.761678,3140.0781 44.167219,"
                        ...
                        + "21.884668,3132.7692 18.950592,3139.9627 z"
                        , pawnStyle);
        
        appendNewPath(g, "M 41.239663,3110.1612 C 41.239663,3114.9277 36.879064,3118.7916 31.499991,"
        ...
        appendNewPath(g, "M 12.11958,3152.6434 C 23.04719,3152.6434 39.914086,3153.0002 50.841696,"
                        ...
                        + "3142.4091 12.11958,3148.3737 12.11958,3152.6434 z"
                        , pawnStyle
                        );
        return g;
    }
