...
public class SVGKingPiece extends SVGChessPiece {
    ...
    public Element getChessPieceElement(String id, Location location, Colour pieceColour) {
        ...
        String styleString_1 = "fill:none;stroke:" + svgColour.stroke + ";stroke-width:0.48899999;stroke-linecap:round";
                               
        String styleString_2 = styleString_1 + "stroke-linejoin:round";
        
        String styleString_3 = "fill:none;stroke:" + svgColour.fill + ";stroke-width:0.48899999;stroke-linecap:round;stroke-linejoin:round";
       
        String styleString_4 = "stroke:" + svgColour.stroke + ";stroke-width:0.48899999";
        
        String styleString_5 = styleString_4 + ";stroke-linecap:round;stroke-linejoin:round";
        ...
        appendNewPath(g[2], "m 541.391,848.41 v -5.625", 
                        "fill:" + svgColour.fill + ";stroke:" + svgColour.fill + ";stroke-width:1.63150001;stroke-linecap:round");
        ...
        appendNewPath(g[2], "m 530.734,869.841 c 5.5,3.5 15.157,3.431 20.657,-0.069 l -0.069,-6.313 c 0,0 "
                        ...
                        + "6.401 z", 
                        "fill:" + svgColour.fill + ";stroke:" + svgColour.fill + ";stroke-width:0.40790001;stroke-linecap:round;stroke-linejoin:round");
        ...
        appendNewPath(g[3], "m 542.635,862.531 c 0,0 8.5,-4 6.026,-9.653 -3.879,-5.85 -13.026,-1.847 -15.526,4.653 l 0.012,2.097 -0.012,"
                        + "-2.097 c -2.5,-6.5 -12.593,-10.503 -15.503,-4.653 -2.497,5.653 4.848,9 4.848,9", styleString_3);
