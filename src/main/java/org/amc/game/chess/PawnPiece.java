 ...
 * without capturing, or on its first move it may advance two squares along the same file without 
 * capturing or the pawn may capture an opponent's piece on a square diagonally in front of it on 
 * an adjacent file, by moving to that square.
 * 
...
public class PawnPiece extends SimplePiece {
    ...
    /**
     * Is dependent on the colour of ChessPiece to know if it's moving forward or not
     ...
     * @param board
     * @param move
     * @return true if there are no other ChessPieces between the ChessPiece and the end Square
     */
