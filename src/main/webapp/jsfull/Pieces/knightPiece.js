    ...
    KnightPiece.prototype = Object.create(ChessPiece.prototype);

    KnightPiece.prototype.toString = function (id, squareCoordinates, playerColour) {
        ...
        return '<g transform="translate(' + this.getCoordX(location) + ',' + this.getCoordY(location) + ')" id="' + id + '"  class="' + this.getClasses(playerColour) +
            '" style="fill:' + this.pieceColour.fill + '"><g transform="matrix(0.47208604,0,0,0.5491603,-78.452298,-1000.8994)" >' +
