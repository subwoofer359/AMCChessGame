    ...
    PawnPiece.prototype = Object.create(ChessPiece.prototype);

    PawnPiece.prototype.toString = function (id, squareCoordinates, playerColour) {
        var location = this.parseSquareCoordinates(squareCoordinates),
            style = 'style="fill:' + this.pieceColour.fill + ';fill-opacity:1;stroke:' +
        ...
        return '<g transform="translate(' + this.getCoordX(location) + ',' + this.getCoordY(location) + ')" id="' + id + '" class="' + this.getClasses(playerColour) + '"> ' +
