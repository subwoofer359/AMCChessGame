    ...
    RookPiece.prototype = Object.create(ChessPiece.prototype);

    RookPiece.prototype.toString = function (id, squareCoordinates, playerColour) {
        var location = this.parseSquareCoordinates(squareCoordinates),
            style = 'style="fill:' + this.pieceColour.fill +
                ';fill-opacity:1;stroke:' + this.pieceColour.stroke +
        ...
        return '<g ' +  'id="' + id + '" class="' + this.getClasses(playerColour) + '" transform="translate(' + this.getCoordX(location) + ',' + this.getCoordY(location) + ')">' +
