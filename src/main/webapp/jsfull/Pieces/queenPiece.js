...
var QueenPieceModule = (function () {
    'use strict';
    function QueenPiece(pieceColour) {
        ChessPieceModule.ChessPiece.call(this, pieceColour);
    }

    QueenPiece.prototype = Object.create(ChessPieceModule.ChessPiece.prototype);

    QueenPiece.prototype.toString = function (id, squareCoordinates, pieceColour) {
        ...
        return '<g transform="translate(' + this.getCoordX(location) + ',' + this.getCoordY(location) + ')" id="' + id + '" class="' + this.getClasses(pieceColour) + '" style="fill:' + pieceColour.fill + '"> ' +
            ...
            '<path d="m 15.65991,34.6016 c 0,3.03265 1.43523,3.36584 2.62527,6.39849 1.189,2.27427 1.53848,1.18312 0.94346,4.97372 -1.78471,1.51588 -1.78471,3.79014 -1.78471,3.79014 -1.78402,2.2747 0.59502,4.67088 0.59502,4.67088 7.7318,1.51633 18.92942,1.51633 26.66122,0 0,0 1.78402,-2.39618 0,-4.67088 0,0 0.59502,-2.27426 -1.18901,-3.79014 -0.59501,' +
                '-3.7906 0.10257,-3.03309 1.29226,-5.30736 1.18901,-3.03264 2.27579,-3.03264 2.27579,-6.06485 -10.11084,-2.27426 -21.30881,-2.27426 -31.4193,0 z"  style="fill:' + pieceColour.fill + ';stroke:' + pieceColour.fill + ';stroke-width:1;stroke-linejoin:round" />' +
            ...
            '<path d="m 17.38651,36.15709 c 0,2.70403 1.5803,2.70403 2.63384,5.40804 1.05354,2.02801 1.05354,1.352 0.52677,4.73202 -1.58031,1.35202 -1.58031,3.38003 -1.58031,3.38003 -1.5803,2.02802 0.52677,3.38003 0.52677,3.38003 6.84799,1.35201 17.38336,1.35201 24.23134,0 0,0 1.5803,-1.35201 0,-3.38003 0,0 0.52677,-2.02801 -1.05354,-3.38003 -0.52675,' +
                '-3.38002 -0.52675,-2.70401 0.52677,-4.73202 1.05354,-2.70401 2.63385,-2.70401 2.63385,-5.40804 -8.95401,-2.02801 -19.48939,-2.02801 -28.44549,0 z"  style="stroke:' + pieceColour.stroke + ';stroke-width:0.72600001;stroke-linejoin:round" />' +
