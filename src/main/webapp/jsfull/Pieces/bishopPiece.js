...
var BishopPieceModule = (function () {
    'use strict';
    ...
    BishopPiece.prototype = Object.create(ChessPieceModule.ChessPiece.prototype);

    BishopPiece.prototype.toString = function (id, squareCoordinates, pieceColour) {
        var location = this.parseSquareCoordinates(squareCoordinates);
        return '<g ' +  'id="' + id + '" class="' + this.getClasses(pieceColour) + '" transform="translate(' + this.getXCoord(location) + ',' + this.getYCoord(location) + ')"><rect width="35.355339" height="4.0406103" x="12.648308" y="55.91304"  style="fill:' + pieceColour.fill + ';fill-opacity:1;stroke:'  + pieceColour.stroke +
