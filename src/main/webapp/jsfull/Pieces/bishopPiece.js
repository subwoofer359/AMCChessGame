/*global ChessPieceModule */
    ...
    function BishopPiece(pieceColour) {

        ChessPiece.call(this, pieceColour);
    }

    BishopPiece.prototype = Object.create(ChessPiece.prototype);

    BishopPiece.prototype.toString = function (id, squareCoordinates, playerColour) {
        var location = this.parseSquareCoordinates(squareCoordinates);
        //playerColour = this.checkColour(playerColour);
        return '<g ' +  'id="' + id + '" class="' + this.getClasses(playerColour) + '" transform="translate(' + this.getCoordX(location) + ',' + this.getCoordY(location) + ')"><rect width="35.355339" height="4.0406103" x="12.648308" y="55.91304"  style="fill:' + this.pieceColour.fill + ';fill-opacity:1;stroke:'  + this.pieceColour.stroke +
            ';stroke-width:0.7;stroke-linecap:butt;stroke-linejoin:round;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none;stroke-dashoffset:50" />' +
