...
public class BishopPieceTest extends ChessPieceTest {
    ...
    public void testOnEmptyBoardIsNotValidMove() {
        ...
        boolean isValid = bishop.isValidMove(this.board, new Move(new Location(
                        ChessBoard.Coordinate.D, 4), new Location(ChessBoard.Coordinate.G, 7)));
        isValid = isValid
                        & bishop.isValidMove(this.board, new Move(new Location(
                                        ChessBoard.Coordinate.D, 4), new Location(
                                        ChessBoard.Coordinate.D, 6)));
        isValid = isValid
                        & bishop.isValidMove(this.board, new Move(new Location(
                                        ChessBoard.Coordinate.D, 4), new Location(
        ...
        isValid = isValid
                        & bishop.isValidMove(this.board, new Move(new Location(
                                        ChessBoard.Coordinate.D, 4), new Location(
                                        ChessBoard.Coordinate.A, 8)));
        // A non move
        isValid = isValid
                        & bishop.isValidMove(this.board, new Move(new Location(
                                        ChessBoard.Coordinate.D, 4), new Location(
                                        ChessBoard.Coordinate.D, 4)));
        assertFalse(isValid);
    }
    ...
    public void testOnBoardIsNotValidMove() {
        ...
        boolean isValid = bishop.isValidMove(this.board, new Move(new Location(
                        ChessBoard.Coordinate.F, 8), new Location(ChessBoard.Coordinate.C, 5)));
