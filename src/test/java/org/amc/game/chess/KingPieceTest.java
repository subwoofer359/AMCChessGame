...
public class KingPieceTest {
    ...
    public void testIsValidMoveOnEmptyBoard() {
        ...
        assertTrue(king.isValidMove(board, cbUtils.createMove("F7", "G7")));
        assertTrue(king.isValidMove(board, cbUtils.createMove("F7", "E7")));

        assertTrue(king.isValidMove(board, cbUtils.createMove("F7", "E8")));
        assertTrue(king.isValidMove(board, cbUtils.createMove("F7", "G8")));
        assertTrue(king.isValidMove(board, cbUtils.createMove("F7", "G6")));
        assertTrue(king.isValidMove(board, cbUtils.createMove("F7", "E8")));
    }
    ...
    public void testIsNotValidMoveOnEmptyBoard() {
        ...
        assertFalse(king.isValidMove(board, cbUtils.createMove("F7", "G3")));
        assertFalse(king.isValidMove(board,
        		cbUtils.createMove("F7", StartingSquare.WHITE_KING.getLocation().asString())));

        assertFalse(king.isValidMove(board, cbUtils.createMove("F7", "D2")));
        assertFalse(king.isValidMove(board, cbUtils.createMove("F7", "C3")));
        assertFalse(king.isValidMove(board, cbUtils.createMove("F7", "G3")));
        assertFalse(king.isValidMove(board, cbUtils.createMove("F7", "D8")));

        assertFalse(king.isValidMove(board, cbUtils.createMove("F7", "F7")));
    ...
    public void testIsValidMoveOnBoard() {
        ...
        boolean isValid = king.isValidMove(board, cbUtils.createMove("F7", "E7"));
        // Move to square occupied by the another king should not be valid
        boolean notValid = king
                        .isValidMove(board, cbUtils.createMove("F7", "G7"));
